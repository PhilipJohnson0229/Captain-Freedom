...
namespace BNG {
    public class SnapZone : MonoBehaviour {
        ...
        [field: SerializeField] public string sId { get; private set; }

        public EquipmentType equipmentType;

        public InventoryItem item;

        [ContextMenu("Generate SnapZone ID")]
        ...
        public void UpdateSlot(InventoryItem _newItem)
        {
            ...
            if (item.data.snapZoneId == sId)
            {
                ...
                {
                    itemText.text = item.data.itemName;
                }
                if (item.stackSize > 1)
                {
        ...
        public virtual void ReleaseAll() {
            ...
            if (HeldItem != null) {
                ...
                // Call event
                if (OnDetachEvent != null && HeldItem != null) {
